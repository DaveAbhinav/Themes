...
import {Text, View, StyleSheet, Image, SafeAreaView, Switch, StatusBar, Platform, } from "react-native";
            ...
            <View style = {styles.container}>
              ...
              <View style = {styles.appTitle}>
                  <View style = {styles.appIcon}>
                      <Image source = {require("../assets/logo.png")} styles ={styles.iconImage}>
                      </Image>
                  </View>
